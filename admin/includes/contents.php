...
<article class="module width_3_quarter" style="width:95%">
    <header><h3 class="tabs_involved">İçerik Listesi</h3>
    ...
    <div class="tab_container">
        ...
        <?php
            $query=query("select * from content where content_approve=1 order by content_id desc");
        ...
        <?php }else{ ?>
            <h4 class='alert_warning'>Henüz hiç içerik eklenmemiş</h4>
        <?php } ?>
    </div>
</article>