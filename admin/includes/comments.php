...
<article class="module width_3_quarter" style="width:95%">
    <header><h3 class="tabs_involved">Yorum Listesi</h3>
    ...
    <div class="tab_container">
        ...
        <?php
            $query=query("select * from comment where comment_approve=1 order by comment_id desc");
            ...
            <table class="tablesorter" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a style="margin-left:10px" onclick="return confirm('Yorumu Silmek  İstediğinizden Emin Misiniz ?')" href="<?php echo URL; ?>/admin/index.php?do=comment_delete&id=<?php echo $row["comment_id"] ?>" title="Sil"><img src="images/icn_trash.png"/></a>
                    </td>
                </tr>
                <?php
                    }
        ...
        <?php }else{ ?>
            <h4 class='alert_warning'>Henüz Hiç Yorum Eklenmemiş</h4>
        <?php } ?>
    </div>
</article>